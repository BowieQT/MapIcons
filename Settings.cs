...
public class MapIconSettings
{
    ...
    public int Size = 32;
    public int Index = 0;
    public SDColor Tint = DXTC.Color.FromHSLA(255, 255, 255, 255);
    public SDColor HiddenTint = DXTC.Color.FromRGBA(128, 128, 128, 255);
    public SDColor ArmingTint = DXTC.Color.FromHSLA(255, 255, 255, 255);
...
public sealed class Settings : ISettings {
    ...
    public int IconCacheUpdateMS = 100; 
    public int IconRebuildUpdateTicks = 5;
    ...
    public bool CustomIconsOpen = false;
